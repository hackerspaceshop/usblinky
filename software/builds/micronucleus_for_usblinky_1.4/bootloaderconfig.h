...
#define USB_CFG_IOPORTNAME      B
   ...
   */
   ...
   // was flipped in default config 



// DMINUS = 4 is correct for usblinky and VUSB   
...
// DPLUS = 3 is correct for usblinky and VUSB
...
//overflo set bootloader timeout to 1 second
